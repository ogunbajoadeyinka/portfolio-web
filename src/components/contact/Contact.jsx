...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Oklahoma, 74074",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "adeyinkaogunbajo302@mail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "405 269 2870",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I'm open to collaborations and consulting projects in AI, data science, and automation. 
                Reach out if you’d like to explore how intelligent systems can drive impact in your organization.
              </p>
            </div>
